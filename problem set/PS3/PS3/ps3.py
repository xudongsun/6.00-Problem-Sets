...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    if not user_end:
        ...
        print('Total scorefor this hand: %d points' % total_score)
    # Return the total score as result of function
    else:
        print('Total score for this hand: %d points' % total_score)
    ...
    * Returns the total score for the series of hands
    ...
    while n_hands > 0:    
        ...
        if n_sub > 0: 
            ...
            hand_p = hand.copy()
        # play a hand
        score_1 = play_hand(hand_p, word_list)
